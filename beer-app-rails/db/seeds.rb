...
#   this_location = Location.create!(name: location["name"], streetAddress: location["streetAddress"])
# end
#
...
# 1290
1.times do |page|
  beersUrl = "http://api.brewerydb.com/v2/beers/?key=9cbedc703b22c38506ed1375ea350381&p=#{page}"
...
for beer in all_beers do
  this_beer = Beer.create!(name: beer["name"], description: beer["description"])
